"""
Login Page - Standalone decorated login page.
"""
...
def render_login():
    ...
    <p style="text-align: center; color: #93C5E0; margin-bottom: 30px; font-size: 15px;">Sign in to continue to Bear's Den</p>
    """, unsafe_allow_html=True)
