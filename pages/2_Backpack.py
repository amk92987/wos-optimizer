...
ITEM_DATA = {
    ...
    "Hero Gear Materials": [
        ...
        {"id": "charm_secrets", "name": "Charm Secrets", "image": "charm_secrets.png", "description": "Material for enhancing charm abilities", "sources": "Events, Shops, Special missions", "uses": "Chief charm upgrades"},
        {"id": "charm_design", "name": "Charm Design", "image": "charm_design.png", "description": "Blueprint for crafting chief charms", "sources": "Events, Packs, Special rewards", "uses": "Crafting chief charms"},
        {"id": "charm_guide", "name": "Charm Guide", "image": "charm_guide.png", "description": "Reference material for charm enhancement", "sources": "Alliance shop, Events, Foundry", "uses": "Guiding charm upgrade processes"},
    ],
