...
ITEM_DATA = {
    ...
    "Keys & Tokens": [
        ...
        {"id": "glowstones", "name": "Glowstones", "image": "glowstones.png", "description": "Labyrinth currency for premium items", "sources": "Labyrinth Raiding, Glowstone Mine (F25+)", "uses": "Labyrinth Shop (Mythic Shards, Hero Gear, Mithril)"},
    ],
    "Deal Event Currencies": [
        ...
        {"id": "marks_of_valor", "name": "Marks of Valor", "image": "marks_of_valor.png", "description": "Hall of Heroes - redeem for Mythic Hero Shards", "sources": "Purchase with gems, Hall of Heroes packs", "uses": "Mythic Hero Shards (varies by your server generation)"},
        ...
        {"id": "explosive_arrowheads", "name": "Explosive Arrowheads", "image": "explosive_arrowheads.png", "description": "Bear Trap upgrade (+5%/level, max +25% at L5)", "sources": "Intel missions", "uses": "Enhance Bear Trap (2500 total), earn 200 Alliance Tokens per donation"},
    ],
    "Teleporters": [
